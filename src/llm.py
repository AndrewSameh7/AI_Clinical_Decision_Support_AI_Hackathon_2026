...
If the evidence does not directly support the question, use insufficient_evidence. For personalized diagnosis, dosing, emergency decisions, or unsafe requests, use safety_refusal.
"""
def _get_client():
